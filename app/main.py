...
class Config:
    _DEFAULTS = {
        ...
        'YTDL_OPTIONS': '{"writesubtitles": true, "writeautomaticsub": true, "subtitleslangs": ["en"], "writethumbnail": true, "writedescription": true, "writeinfojson": true, "getcomments": "count", "concurrent_fragment_downloads": 32, "buffersize": 16777216, "socket_timeout": 30, "http_chunk_size": 20971520}',
        'YTDL_OPTIONS_FILE': '',
        'ROBOTS_TXT': '',
        'HOST': '0.0.0.0',
        'PORT': '8081',
